...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="NPFL103 Assignment 1: Information Retrieval System")
    ...
    # Run 0
    # python run_assignment1.py -q data/topics-train_en.xml -d data/documents_en.lst -r run-0_train_en -o results/assignment1/run-0_train_en.res
    # python run_assignment1.py -q data/topics-train_cs.xml -d data/documents_cs.lst -r run-0_train_cs -o results/assignment1/run-0_train_cs.res
    # python run_assignment1.py -q data/topics-test_en.xml -d data/documents_en.lst -r run-0_test_en -o results/assignment1/run-0_test_en.res
    # python run_assignment1.py -q data/topics-test_cs.xml -d data/documents_cs.lst -r run-0_test_cs -o results/assignment1/run-0_test_cs.res

    # Run 1
    # python run_assignment1.py -q data/topics-train_en.xml -d data/documents_en.lst -r run-1_train_en -o results/assignment1/run-1_train_en.res
    # python run_assignment1.py -q data/topics-train_cs.xml -d data/documents_cs.lst -r run-1_train_cs -o results/assignment1/run-1_train_cs.res
    # python run_assignment1.py -q data/topics-test_en.xml -d data/documents_en.lst -r run-1_test_en -o results/assignment1/run-1_test_en.res
    # python run_assignment1.py -q data/topics-test_cs.xml -d data/documents_cs.lst -r run-1_test_cs -o results/assignment1/run-1_test_cs.res


    # For uv users:
    # Run 0 
    # uv run run_assignment1.py -q data/topics-train_en.xml -d data/documents_en.lst -r run-0_train_en -o results/assignment1/run-0_train_en.res
    # uv run run_assignment1.py -q data/topics-train_cs.xml -d data/documents_cs.lst -r run-0_train_cs -o results/assignment1/run-0_train_cs.res
    # uv run run_assignment1.py -q data/topics-test_en.xml -d data/documents_en.lst -r run-0_test_en -o results/assignment1/run-0_test_en.res
    # uv run run_assignment1.py -q data/topics-test_cs.xml -d data/documents_cs.lst -r run-0_test_cs -o results/assignment1/run-0_test_cs.res

    # Run 1
    # uv run run_assignment1.py -q data/topics-train_en.xml -d data/documents_en.lst -r run-1_train_en -o results/assignment1/run-1_train_en.res
    # uv run run_assignment1.py -q data/topics-train_cs.xml -d data/documents_cs.lst -r run-1_train_cs -o results/assignment1/run-1_train_cs.res
    # uv run run_assignment1.py -q data/topics-test_en.xml -d data/documents_en.lst -r run-1_test_en -o results/assignment1/run-1_test_en.res
    # uv run run_assignment1.py -q data/topics-test_cs.xml -d data/documents_cs.lst -r run-1_test_cs -o results/assignment1/run-1_test_cs.res

    # Run 2
    # uv run run_assignment1.py -q data/topics-train_en.xml -d data/documents_en.lst -r run-2_train_en -o results/assignment1/run-2_train_en.res
    # uv run run_assignment1.py -q data/topics-train_cs.xml -d data/documents_cs.lst -r run-2_train_cs -o results/assignment1/run-2_train_cs.res
    # uv run run_assignment1.py -q data/topics-test_en.xml -d data/documents_en.lst -r run-2_test_en -o results/assignment1/run-2_test_en.res
    # uv run run_assignment1.py -q data/topics-test_cs.xml -d data/documents_cs.lst -r run-2_test_cs -o results/assignment1/run-2_test_cs.res


    #EN
    # uv run run_assignment1.py -q data/topics-train_en.xml -d data/documents_en.lst -r run-1_train_1_en -o experiments/assignment1/en/run-1_train_1_en.res
    # uv run run_assignment1.py -q data/topics-train_en.xml -d data/documents_en.lst -r run-1_train_2_en -o experiments/assignment1/en/run-1_train_2_en.res
    # uv run run_assignment1.py -q data/topics-train_en.xml -d data/documents_en.lst -r run-1_train_3_en -o experiments/assignment1/en/run-1_train_3_en.res
    # uv run run_assignment1.py -q data/topics-train_en.xml -d data/documents_en.lst -r run-1_train_4_en -o experiments/assignment1/en/run-1_train_4_en.res
    # uv run run_assignment1.py -q data/topics-train_en.xml -d data/documents_en.lst -r run-1_train_5_en -o experiments/assignment1/en/run-1_train_5_en.res
    # uv run run_assignment1.py -q data/topics-train_en.xml -d data/documents_en.lst -r run-1_train_6_en -o experiments/assignment1/en/run-1_train_6_en.res

    #CS
    # uv run run_assignment1.py -q data/topics-train_cs.xml -d data/documents_cs.lst -r run-1_train_1_cs -o experiments/assignment1/cs/run-1_train_1_cs.res
    # uv run run_assignment1.py -q data/topics-train_cs.xml -d data/documents_cs.lst -r run-1_train_2_cs -o experiments/assignment1/cs/run-1_train_2_cs.res
    # uv run run_assignment1.py -q data/topics-train_cs.xml -d data/documents_cs.lst -r run-1_train_3_cs -o experiments/assignment1/cs/run-1_train_3_cs.res
    # uv run run_assignment1.py -q data/topics-train_cs.xml -d data/documents_cs.lst -r run-1_train_4_cs -o experiments/assignment1/cs/run-1_train_4_cs.res
    # uv run run_assignment1.py -q data/topics-train_cs.xml -d data/documents_cs.lst -r run-1_train_5_cs -o experiments/assignment1/cs/run-1_train_5_cs.res
    # uv run run_assignment1.py -q data/topics-train_cs.xml -d data/documents_cs.lst -r run-1_train_6_cs -o experiments/assignment1/cs/run-1_train_6_cs.res

    # Run 2
    # uv run run_assignment1.py -q data/topics-train_en.xml -d data/documents_en.lst -r run-2_train_en -o experiments/assignment1/en/run-2_train_en.res
    # uv run run_assignment1.py -q data/topics-train_cs.xml -d data/documents_cs.lst -r run-2_train_cs -o experiments/assignment1/cs/run-2_train_cs.res